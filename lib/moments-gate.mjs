 ...
 * message. So raising the cap here is the whole change, and the printed
 * promise cannot drift from the rule that enforces it. The unit suite pins
 * the gate against this value at exactly LIVE_CAP and LIVE_CAP + 1.
 */
