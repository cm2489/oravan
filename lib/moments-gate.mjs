...
export function checkMoments(moments, slugsByKind, statusFor, opts = {}) {
  ...
  if (liveCount > 8) {
    violations.push(`data/moments.json: ${liveCount} live moments — the cap is 8 (scarcity keeps curation honest, spec §4.3; raised from 6 by owner ruling 2026-09-24)`);
  }
