 ...
 *  characters, so none of them could ever have run. Shorter probes (331 and
 *  225 characters) drew only 429s and connection timeouts from that machine,
 *  so the real ceiling is UNMEASURED: it is below 436, and this value is a
 *  starting point under that, not a known-good length. The collector corrects
