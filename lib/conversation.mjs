 ...
 *      MOST_VIEWED_ONLY_CARD_CAP most-viewed-only cards.
 ...
 *  may be most-viewed-only (no rated basket article beside them). Exported
 *  here so the number lives with the rule that motivates it (critic B-2) and
 *  cannot drift between the writer and the renderer. */
export const MOST_VIEWED_ONLY_CARD_CAP = 2;
