...
- **Now:** Merged: #44 (S24 federal boundary-source hardening), #45 (S17 frame-ancestors split posture). Awaiting review: #46 (S23 citability/correction page), #47 (S14 bill-card widget), #48 (S25 triage spec), #49 (S21 pregen dark), #50 (fix: MCP envelope/refine_hint/tool-error ES localization, off-plan rider closing a gap #46 pinned) — S15/S16 queued behind #47.
